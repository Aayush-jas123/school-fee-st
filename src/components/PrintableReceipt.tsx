      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-3xl w-full p-6 shadow-2xl overflow-y-auto max-h-[95vh] text-slate-100 relative">
        ...
        <div className="bg-white text-slate-900 p-8 rounded-2xl border border-slate-200 space-y-5 shadow-md print:shadow-none print:border-none print:p-0">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs bg-slate-50 p-4 rounded-xl border border-slate-200">
            ...
            <div>
              <p><span className="text-slate-500">Course Program:</span> <strong className="text-indigo-900 font-extrabold">{student.course} (2-Year)</strong></p>
          ...
          <div>
            ...
            <table className="w-full text-xs border-collapse border border-slate-300">
              <tbody>
                <tr>
                  <td className="border border-slate-300 p-2 font-medium text-slate-600 w-1/3">Payment For</td>
                ...
                <tr>
                  <td className="border border-slate-300 p-2 font-medium text-slate-600">Description</td>
                ...
                <tr>
                  <td className="border border-slate-300 p-2 font-medium text-slate-600">Payment Mode</td>
                  <td className="border border-slate-300 p-2 font-bold">{payment.mode}</td>
                </tr>
                <tr>
                  <td className="border border-slate-300 p-2 font-medium text-slate-600">Transaction Reference</td>
